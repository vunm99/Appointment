...
public class loginAdm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (Model.Admin.loginAdmin(email, password) != null) {
                request.getSession().setAttribute("loginAdm", Model.Admin.loginAdmin(email, password));
                request.getRequestDispatcher("homeAdm.jsp").forward(request, response);
            } else {
                request.setAttribute("loginAdmFail", "Please check Email and Password.");
