...
<jsp:useBean id="admin" class="Model.Admin" scope="session"></jsp:useBean>
    ...
    <html>
        ...
        <c:if test="${DeleteSuccess!=null ||editDocSuccess!=null}">
            <div class="alert alert-success" role="alert">
                ${DeleteSuccess}${editDocSuccess}
            </div>
        </c:if>
        <c:if test="${DeleteFail!=null ||editDocFail!=null}">
            <div class="alert alert-danger" role="alert">
                ${DeleteFail}${editDocFail}
            </div>
        </c:if>
        ...
        <table border="1" cellpadding="5" cellspacing="1" >
            ...
            <c:forEach items="${admin.getAllDoctor()}" var="doctor" >
                <tr>
                    <td>${doctor.dId}</td>
                    <td>${doctor.dName}</td>
                    <td>${doctor.dEmail}</td>
