...
<html>
    ...
    <body>
        <div class="container">
            <center>
                <strong><h1>SIGN IN PATIENT</h1></strong>
                <div class="col-8">
                    <form action="signInPat" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10"> 
                                <input class="form-control" type="text"  id="example-password-input" name="disease" required>
                            </div>              
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10"> 
                                <input class="form-control" type="text"  id="example-password-input" name="status" required>
                            </div>              
                        </div>
